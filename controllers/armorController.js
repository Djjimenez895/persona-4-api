function armorController(Armor) {
  /* TODO: Implement a get request (/armor URI) that returns all
  armor in the database */
  function get(req, res) {

  }

  /* TODO: Implement a post request (/armor URI) that returns all
  armor in the database */
  function post(req, res) {

  }

  /* TODO: Implement a get request (/armor/effect/:effectType/:amount URI)
